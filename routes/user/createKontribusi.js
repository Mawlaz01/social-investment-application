...
// GET form untuk memilih kategori kontribusi
...
// POST untuk memilih kategori dan menampilkan form yang sesuai
...
// GET form untuk menambahkan kontribusi
...
// POST untuk menyimpan kontribusi baru
router.post('/:id/create_kontribusi', auth, async (req, res) => {
    try {
        ...
        // Save general contribution data
        ...
        // Save specific contribution data
        if (jumlah_uang) {
